...
const PostWidget = ({
    ...
    const [isLiked, setIdLiked] = useState(Boolean(likes[loggedInUserId]))
    ...
    const patchLike = async () => {
        setIdLiked(!isLiked)
        const response = await fetch(`https://social-c60a.onrender.com/posts/${postId}/like`, {
            method: 'PATCH',
            headers: {
        ...
        <WidgetWrapper m="2rem 0">
            ...
            {picturePath && (
                <img
                    ...
                    src={`https://social-c60a.onrender.com/assets/${picturePath}`}
                />
            )}
