...
const Form = () => {
    ...
    const register = async (values, onSubmitProps) => {
        ...
        const saveUserResponse = await fetch('https://social-c60a.onrender.com/auth/register', {
            method: 'POST',
            body: formData,
        })
    ...
    const login = async (values, onSubmitProps) => {
        try {
            const loggedInResponse = await fetch('https://social-c60a.onrender.com/auth/login', {
                method: 'POST',
